...
export class OfficeConversionService {
    ...
    ConvertFile(endpointSlug: string, file: File | null, outputFilename?: string, fileKey?: string): Observable<HttpEvent<any>> {
        ...
        return this.http.post(`${this.officeToolsUrl}/${finalEndpoint}`, formData, {
            reportProgress: true,
            observe: 'events'
        });
    }
